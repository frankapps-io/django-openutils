.PHONY: help install install-dev test test-cov lint format clean build publish-test publish release venv
...
VENV := venv
VENV_BIN := $(VENV)/bin
PACKAGE := django_openutils

# Default target
help:
	@echo "Django OpenUtils - Development Commands"
	@echo ""
	@echo "Setup:"
...
publish-test: build
	...
	@echo "  pip install --index-url https://test.pypi.org/simple/ django-openutils"

publish: build
	@echo "Publishing to PyPI..."
	@echo "This will publish to the REAL PyPI. Are you sure? [Ctrl+C to cancel]"
	@read -p "Press Enter to continue..."
	twine upload dist/*
	@echo ""
	@echo "Published to PyPI!"
	@echo "Install with: pip install django-openutils"
